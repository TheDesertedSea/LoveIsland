package com.example.uidesign.ui.likeAnimation;
...
public class LikeButtonView extends FrameLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        ivStar = (ImageView) this.findViewById(R.id.ivStar);
        vDotsView = (DotsView) this.findViewById(R.id.vDotsView);
        vCircle = (CircleView) this.findViewById(R.id.vCircle);
    ...
    public void onClick(View v) {
        isChecked =! isChecked;
        ivStar.setImageResource(isChecked ? R.drawable.ic_liked_24dp : R.drawable.ic_like_non_24dp);
